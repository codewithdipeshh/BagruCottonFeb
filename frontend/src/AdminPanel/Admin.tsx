...
export default function Admin() {
  ...
  const menuItems = [
    ...
    { path: '/admin/products', name: 'All Products', icon: <ShoppingBag className="w-4 h-4" /> },
    { path: '/admin/product/add', name: 'Add Product', icon: <PlusCircle className="w-4 h-4" /> },
    { path: '/admin/orders', name: 'Orders', icon: <ListOrdered className="w-4 h-4" /> },
    { path: '/admin/customers', name: 'Customers', icon: <Users className="w-4 h-4" /> },
  ];
